                ...
                <div class="profile-header text-center">
                    ...
                    <form id="form">
                        <div class="form-group">
                            ...
                            <label id="namelabel" class="form-control-placeholder" for="name">Enter your Name</label>
                            <label id="nameerror" class="form-control-placeholder text-danger d-none" for="name">Required Field</label>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="bio" required/>
                            <label id="biolabel" class="form-control-placeholder" for="bio">Enter your Bio</label>
                            <label id="bioerror" class="form-control-placeholder" for="bio"></label>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="tags" required/>
                            <label id="tagslabel" class="form-control-placeholder" for="tags">Enter tags. Separate by ";"</label>
                            <label id="tagserror" class="form-control-placeholder" for="tags"></label>
                        </div>
                        <select class="form-select">
                            <option selected class="form-control" id="genre">Select your favorite genre</option>
                            <option value="Action">One</option>
                            <option value="Drama">Two</option>
                            <option value="Comedy">Three</option>
                        </select>
                        <p class="text-white">Joined In 2022</p>
                        <button type="button" class="btn btn-primary confirm" onclick="confirm();"> Confirm </button>
                        <button type="button" class="btn btn-danger cancel" onclick="cancel();"> Cancel </button>
                    </form>
                </div>
